...
(function(module) {
  ...
  // DONE Give the IIFE a parameter called 'module'.
  // DONE At the very end of the code, but still inside the IIFE, attach the 'Article' object to 'module'.
  // DONE Where the IIFE is invoked, pass in the global 'app' object that is defined above.
